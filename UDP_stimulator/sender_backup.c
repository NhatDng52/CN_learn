...
int main() {
    ...
    // Payload
    printf("type data you want to send through UDP \n");
    char user_input[1024]; // Giới hạn kích thước dữ liệu nhập từ người dùng
    // Get and save the text
    scanf("%s", user_input);
    const char *data = user_input;
    ...
    psh.src_address = inet_addr("127.0.0.1");  // chuyển string thành hexa IP
    psh.dst_address = inet_addr("127.0.0.1"); // chuyển string thành hexa IP
    psh.placeholder = 0;
